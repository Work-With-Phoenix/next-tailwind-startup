    ...
    return(
        ...
        <main className="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto my-auto px-4 sm:px-6 lg:px-8">
          <div className="flex-shrink-0 flex justify-center">
            <Link href={"https://github.com/Work-With-Phoenix"}  >
          ...
          <div className="pb-16 pt-8">
            <div className="text-center flex flex-col items-center justify-center">
              ...
              <p className="mt-2 text-base text-gray-500">Your Next.js & Tailwind  are now in sync.</p>
              <div className="mt-6">
                <Link href={"https://github.com/Work-With-Phoenix/next-tailwind-startup#readme"}  >
                  <a className="text-base font-medium text-indigo-600 hover:text-indigo-500 flex space-x-2" target={"_blank"}>
        ...
        <footer className="flex-shrink-0 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link href={"https://github.com/Work-With-Phoenix/.github/blob/main/profile/README.md"}  >
             <a target={"_blank"} className="text-sm font-medium text-gray-500 hover:text-gray-600"> Community</a>
            </Link>
            <span className="inline-block border-l border-gray-300" aria-hidden="true" />
            <Link href={"https://github.com/Work-With-Phoenix"} >
             <a target={"_blank"} className="text-sm font-medium text-gray-500 hover:text-gray-600"> Tutorials</a>
              
            </Link>
            <span className="inline-block border-l border-gray-300" aria-hidden="true" />
            <Link href={"https://github.com/orgs/Work-With-Phoenix/repositories"} >
             <a target={"_blank"} className="text-sm font-medium text-gray-500 hover:text-gray-600"> Resources</a>
